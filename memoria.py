...
"""
cuadros = [
    [Cuadro("assets/cebra.png"), Cuadro("assets/cebra.png"),
     Cuadro("assets/elefante.png"), Cuadro("assets/elefante.png")],
    [Cuadro("assets/zorro.png"), Cuadro("assets/zorro.png"),
     Cuadro("assets/oso.png"), Cuadro("assets/oso.png")],
    [Cuadro("assets/leon.png"), Cuadro("assets/leon.png"),
     Cuadro("assets/hipopotamo.png"), Cuadro("assets/hipopotamo.png")],
    [Cuadro("assets/jirafa.png"), Cuadro("assets/jirafa.png"),
     Cuadro("assets/tigre.png"), Cuadro("assets/tigre.png")],
]
